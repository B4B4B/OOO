...
Its Easy!!
سجل دخول لحسابك /login. 

عندك خيارين:

1. عن طريق اسم المستخدم:

ارسل لي اسم مستخدم الخاص بك.
...
تكدر ايضا ارسال رابط بوست او فيديو لتحميله.
...
/start - لبدأ البوت
/restart - اعادة تشغيل البوت (فقط ارسل  /restart.)
/help - يطلعلك هاي قائمة.
/login - تسجيل الدخول الى حسابك.
/logout - تسجيل الخروج من الحساب.
/account - يضهر لك تفاصيل حسابك.

/posts <username> - تحميل البوست عن طريق اليوزر نيم. Use /posts to download own posts or <code> /posts <username> </code>for others.
Example : <code>/posts samantharuthprabhuoffl</code>

/igtv <username> - تكدر تنزل مقاطع فيديو IGTV
